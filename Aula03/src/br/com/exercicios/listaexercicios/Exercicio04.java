...
public class Exercicio04 implements Exercicio {
	...
	public void run() {
		...
		System.out.println("4. Leia um número qualquer fornecido pelo usuário. \n"
				+ "Determine se o número é maior do que 100, imprimindo uma\n"
				+ "mensagem indicando que o \"valor é maior que 100\" ou uma mensagem \n"
				+ "indicando que o \"valor é menor ou igual a 100\". \n");
